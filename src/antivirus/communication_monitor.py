...
class CommunicationMonitor:
    ...
    def analyze_email_real_time(self, sender: str, subject: str, content: str) -> Dict:
        ...
        if result['is_phishing']:
            self._block_communication('email', {
                'sender': sender,
                'subject': subject,
            ...
            print(colored(f"  Recommended Action: {result['recommended_action']}", 'yellow'))
    ...
    def analyze_call_real_time(self, phone_number: str, call_content: str = "") -> Dict:
        ...
        if result['is_fake_call']:
            self._block_communication('call', {
    ...
    def analyze_message_real_time(self, sender: str, content: str, platform: str = "SMS") -> Dict:
        ...
        if result['is_suspicious']:
            self._block_communication('message', {
                'sender': sender,
                'platform': platform,
                'threat_type': result['threat_type'],
                'confidence': result['confidence_score']
    ...
    def get_monitoring_status(self) -> Dict:
        ...
        return {
            ...
            'recent_blocks': self.blocked_communications[-10:] if self.blocked_communications else []
        }
    
    def get_blocked_communications(self, limit: int = 50) -> List[Dict]:
        """Get recent blocked communications"""
        return self.blocked_communications[-limit:] if self.blocked_communications else []
    ...
    def report_false_positive(self, communication_id: str):
        ...
        print(colored(f"📝 False positive reported for communication {communication_id}", 'yellow'))
