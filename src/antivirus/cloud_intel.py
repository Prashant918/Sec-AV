        ...
        try:
            ...
            if vt_result:
                ...
                if vt_result.get('positives', 0) > 0:
                    ...
                    reputation_data['threat_names'].extend(vt_result.get('threat_names', []))
            ...
            if ha_result:
                ...
                if ha_result.get('threat_score', 0) > 50:
                    ...
                    reputation_data['threat_names'].extend(ha_result.get('threat_names', []))
            
            # Calculate confidence based on number of sources
            reputation_data['confidence'] = min(len(reputation_data['sources_checked']) / 3.0, 1.0)
